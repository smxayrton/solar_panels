    ...
    <div class="row">
      ...
      <div class="col-lg-5 col-md-6">
        <?php if( get_theme_mod( 'vw_ecommerce_store_location') != '' ) { ?>
          <span><i class="fas fa-map-marker-alt"></i><?php echo esc_html(get_theme_mod('vw_ecommerce_store_location','') ); ?></span>
        <?php }?>
      </div>
      <div class="col-lg-4 col-md-3">
        <?php if( get_theme_mod( 'vw_ecommerce_store_order_tracking') != '') { ?>
          <div class="order-track">
            <span><i class="fas fa-truck"></i><?php echo esc_html_e('Order Tracking','vw-ecommerce-store'); ?></span>
